...
rz(-pi) q[10];
x q[2];
rz(-0.6452964941384955) q[2];
cx q[2],q[14];
rz(-pi/2) q[14];
sx q[14];
rz(1.115965959414936) q[14];
sx q[14];
x q[2];
rz(5.637888813041087) q[2];
cx q[2],q[12];
rz(pi/2) q[12];
sx q[12];
rz(-pi/2) q[12];
