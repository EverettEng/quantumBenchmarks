...
cx q[5],q[1];
rz(pi/2) q[1];
rz(2.9000539646659336) q[8];
sx q[8];
rz(-1.4214888733983795) q[8];
sx q[8];
rz(-2.598358994843574) q[8];
cx q[9],q[0];
cx q[0],q[4];
rz(pi/2) q[0];
sx q[0];
