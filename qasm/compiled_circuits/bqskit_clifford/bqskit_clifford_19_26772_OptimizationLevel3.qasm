...
rz(-pi/2) q[14];
sx q[14];
rz(-2.125596066487284) q[14];
sx q[14];
rz(pi/2) q[14];
cx q[3],q[14];
rz(-pi/2) q[14];
sx q[14];
rz(-2.125596066487285) q[14];
sx q[14];
rz(pi/2) q[14];
sx q[3];
rz(pi/2) q[3];
...
cx q[5],q[10];
cx q[8],q[15];
rz(0.48919977589817343) q[15];
sx q[15];
rz(-1.2834504648786265) q[15];
sx q[15];
rz(-0.4891997758981743) q[15];
sx q[8];
rz(-pi/2) q[8];
sx q[9];
rz(pi/2) q[9];
