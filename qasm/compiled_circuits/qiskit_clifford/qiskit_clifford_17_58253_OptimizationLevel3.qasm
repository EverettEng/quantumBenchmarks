...
rz(-pi/2) q[13];
sx q[13];
rz(-1.3675049472125718) q[13];
sx q[13];
rz(pi/2) q[13];
cx q[11],q[13];
rz(pi/2) q[13];
sx q[13];
rz(-1.7740877063772214) q[13];
sx q[13];
rz(-pi/2) q[13];
cx q[13],q[0];
cx q[0],q[7];
...
rz(pi/2) q[8];
cx q[16],q[8];
rz(-0.2844135835581483) q[16];
sx q[16];
rz(pi/2) q[16];
cx q[5],q[16];
rz(pi/2) q[16];
sx q[16];
rz(-2.8571790700316457) q[16];
sx q[16];
rz(pi/2) q[16];
sx q[5];
rz(-pi/2) q[5];
